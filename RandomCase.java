...
public class RandomCase {
    ...
    public static void main(String[] args) {
        ...
        int[] arrHeapSort= new int[sizeOfArray];
        ...
        //Sorting arrInsSort array using Heap Sort

        HeapSort HS = new HeapSort();
        System.out.println("Unsorted Array for Heap Sort : ");
        P1.printUnsortedArray(arrHeapSort);
        final long startTime5 = System.currentTimeMillis();
        HS.heap_sort(arrHeapSort);
        final long endTime5 = System.currentTimeMillis();
        System.out.println();
        System.out.print("Sorted Array using HEAP SORT:  ");
        HS.printHeapSortArray(arrHeapSort);
        System.out.println();
        System.out.println("Total execution time for Heap Sort: " + P1.timeTakenforSorting(startTime5, endTime5) );
        ...
        System.out.println("Unsorted Array for In-Place Quick Sort : ");
